...
/** COO format for tensors Stores non-zero entries as (indices, value)
  */
...
/** Factor matrix for tensor decomposition Used in CP decomposition and similar
  * algorithms
  */
